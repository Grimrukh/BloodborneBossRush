...
def Constructor():
    ...
    RunEvent(
        12424785,
        slot=0,
        args=(Characters.CelestialEmissarySmall, 2422816, 10, Flags.CelestialEmissaryBattleStarted),
    )
    ...
    RunEvent(
        ...
        slot=0,
        args=(
            Characters.CelestialMinion1,
            2422816,
            10,
            Flags.CelestialEmissaryBattleStarted,
            Characters.CelestialEmissarySmall,
        ),
    )
    RunEvent(
        12424787,
