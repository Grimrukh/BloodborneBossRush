...
def Constructor():
    ...
    RunEvent(
        13504410,
        slot=0,
        args=(5, 3500940, 3502920, 13504420, 13504430, 13504440, Flags.LivingFailuresDead, 10564),
    )
...
def LadyMariaDies():
    ...
    DisableBossHealthBar(Characters.LadyMaria, name=452000, slot=0)
...
def StopLadyMariaMusic():
    ...
    DisableBossMusic(-1)
    CreateVFX(3503500)  # Also handles these FX.
...
def LivingFailuresDie():
    ...
    DisableBossHealthBar(Characters.LivingFailuresHealthPool, name=403000, slot=0)
    DisplayBanner(BannerType.PreySlaughtered)
...
def Event13500150():
    ...
    IfAttackedWithDamageType(-2, attacked_entity=3500932, attacker=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(2, input_condition=-2)
    IfConditionTrue(3, input_condition=-1)
    IfCharacterInsideRegion(3, PLAYER, region=3502328)
    IfEntityWithinDistance(-3, PLAYER, 3500931, radius=2.0)
    IfAttackedWithDamageType(-3, attacked_entity=3500931, attacker=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(4, input_condition=-3)
...
def Event13500430(_, arg_0_3: int, arg_4_7: int, arg_8_11: int):
    ...
    EndIfFlagOn(arg_0_3)
    IfAttackedWithDamageType(1, attacked_entity=arg_4_7, attacker=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(-1, input_condition=1)
...
def Event13500460(_, arg_0_3: int, arg_4_7: int, arg_8_11: int):
    ...
    IfAttackedWithDamageType(0, attacked_entity=arg_0_3, attacker=-1, damage_type=DamageType.Unspecified)
...
def Event13505400(_, arg_0_3: int, arg_4_7: int, arg_8_11: float, arg_12_15: int):
    ...
    IfAttackedWithDamageType(-2, attacked_entity=arg_0_3, attacker=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(2, input_condition=-2)
    IfConditionTrue(-3, input_condition=1)
    IfConditionTrue(-3, input_condition=2)
    IfConditionTrue(0, input_condition=-3)
...
def Event13505470(_, arg_0_3: int, arg_4_7: int, arg_8_11: int, arg_12_15: int):
    ...
    ForceAnimation(arg_0_3, arg_4_7)
    SetAIParamID(arg_0_3, 402040)
    IfAttackedWithDamageType(1, attacked_entity=arg_0_3, attacker=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(-1, input_condition=1)
    IfHasAIStatus(-1, arg_0_3, ai_status=AIStatusType.Caution)
    IfHasAIStatus(-1, arg_0_3, ai_status=AIStatusType.Search)
    IfHasAIStatus(-1, arg_0_3, ai_status=AIStatusType.Battle)
...
def Event13505570(_, arg_0_3: int, arg_4_7: int, arg_8_11: float, arg_12_15: float, arg_16_19: int, arg_20_23: int, 
    ...
    IfAttackedWithDamageType(-6, attacked_entity=arg_0_3, attacker=-1, damage_type=DamageType.Unspecified)
...
def Event13500910(_, arg_0_3: int, arg_4_7: int):
    ...
    IfCharacterHuman(15, PLAYER)
    EndIfConditionFalse(15)
    IfAttackedWithDamageType(0, attacked_entity=arg_0_3, attacker=PLAYER, damage_type=DamageType.Unspecified)
    WaitFrames(1)
    IfAttackedWithDamageType(0, attacked_entity=arg_0_3, attacker=PLAYER, damage_type=DamageType.Unspecified)
    WaitFrames(1)
    IfAttackedWithDamageType(0, attacked_entity=arg_0_3, attacker=PLAYER, damage_type=DamageType.Unspecified)
...
def Event13500994(_, arg_0_3: int, arg_4_7: int, arg_8_11: int, arg_12_15: int, arg_16_19: int, arg_20_23: float, 
    ...
    IfAttackedWithDamageType(1, attacked_entity=arg_0_3, attacker=PLAYER, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=1)
    EnableFlag(arg_12_15)
    WaitFrames(1)
