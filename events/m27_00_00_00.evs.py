...
def Constructor():
    ...
    RunEvent(
        9280,
        slot=6,
        args=(2700710, 12704220, 12704221, 2700, Flags.ShadowsOfYharnamFogEntered, 27, 0),
        arg_types="iiiiiBB",
    )
    ...
    RunEvent(
        12704410,
        slot=0,
        args=(5, 2700920, 2702910, 12704420, 12704430, 12704440, Flags.ShadowsOfYharnamDead, 10561),
    )
    RunEvent(
        12704410,
        slot=1,
        args=(5, 2700921, 2702913, 12704421, 12704431, 12704441, Flags.ShadowsOfYharnamDead, 10565),
    )
    ...
    RunEvent(
        12704460,
        slot=0,
        args=(2700920, 2702914, 2702800, 2702801, 101130, Flags.ShadowsOfYharnamFogEntered, 2702801),
    )
    RunEvent(
        12704460,
        slot=1,
        args=(2700921, 2702911, 2702800, 2702801, 101130, Flags.ShadowsOfYharnamFogEntered, 2702801),
    )
...
def ShadowsOfYharnamDie():
    ...
    DisableBossHealthBar(Characters.Shadow1, name=212010, slot=2)
    DisableBossHealthBar(Characters.Shadow2, name=212020, slot=1)
    DisableBossHealthBar(Characters.Shadow3, name=212030, slot=0)
