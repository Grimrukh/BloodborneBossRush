...
def OneRebornDies():
    ...
    Kill(Characters.OneRebornMaiden1, award_souls=False)
    Kill(Characters.OneRebornMaiden2, award_souls=False)
    Kill(Characters.OneRebornMaiden3, award_souls=False)
